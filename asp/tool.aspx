...
<body>
    ...
    <table style=" position: absolute; margin-left:10px; margin-right:200px; margin-top:0px; width:635px; height:106px; top: 10px; left: 10px;">  
        ...
        <br />
        <asp:Button ID="Button2" runat="server" OnClientClick="return confirm('Are u sure?');"  OnClick="Button2_Click" Text="点击结束电池充电页面，转换江河3页面" Height="88px" Width="276px" />
        <br />
        <br />
        ...
        <p>
            测试用工具区</p>
        <p>
            <asp:Button ID="Button3" runat="server" OnClientClick="return confirm('Are u sure?');" OnClick="Button3_Click" Text="切换到电池充电页面，屏蔽页面3" Height="88px" Width="276px"/>
        </p>
    </form>
</body>
</html>
